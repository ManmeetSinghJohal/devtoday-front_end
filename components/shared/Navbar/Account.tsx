      ...
      <Menubar className="relative rounded-[6px] bg-transparent shadow-none">
        <MenubarMenu>
          ...
          <MenubarContent className="paragraph-3-medium mr-5 mt-3.5 flex w-[174px] flex-col gap-3.5 border-white-border p-5 shadow-none dark:border-dark-700 dark:bg-dark-800 md:rounded-t-none md:border-t-0">
            <MenubarItem className="flex cursor-pointer gap-2.5 px-0">
              <Link href="/profile">
                <ProfileIcon />
                Profile
              </Link>
            ...
            <MenubarItem
              className="flex cursor-pointer gap-2.5 px-0 text-primary1-500 hover:text-primary1-500"
              onClick={() => signOut()}
            >
              <Image
                alt="Log out"
            ...
            <MenubarItem className="flex w-full justify-between px-0 font-semibold">
              Interface
