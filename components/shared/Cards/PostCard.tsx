...
const PostCard = () => {
  return (
    <section className="flex w-full flex-col gap-5">
      {mockPosts.map(
        ({ title, id, content, tags, comments, views, createdAt }: any) => {
          return (
            <div
              key={id}
              className="flex flex-col items-start gap-3 rounded-2xl bg-white-100 p-5 dark:bg-dark-800 lg:flex-row lg:gap-5"
            >
              <Image
                alt="post image"
                width={165}
